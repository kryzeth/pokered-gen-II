...
DEF SAFARI_ROCK EQU CASCADEBADGE ; overload
	...
	const SECRET_KEY    ; $2B
	const METAL_COAT    ; $2C ; was unused
	const BIKE_VOUCHER  ; $2D
	const X_ACCURACY    ; $2E
	const LEAF_STONE    ; $2F
	const CARD_KEY      ; $30
	const NUGGET        ; $31
	const KINGS_ROCK    ; $32 ; was unused
	const POKE_DOLL     ; $33
	const FULL_HEAL     ; $34
	const REVIVE        ; $35
	const MAX_REVIVE    ; $36
	...
	const LIFT_KEY      ; $4A
	const EXP_ALL       ; $4B
	const SUN_STONE     ; $54	newly added
	const ICE_STONE	    ; $55	newly added
	const SUPER_ROD     ; $4E
	const PP_UP         ; $4F
	const ETHER         ; $50
	const MAX_ETHER     ; $51
...
DEF TM01 EQU const_value
	...
	add_tm FLAMETHROWER ; $D4	Replaced Water Gun, since you get Bubblebeam immediately afterwards
	add_tm ICE_BEAM     ; $D5
	add_tm BLIZZARD     ; $D6
	...
	add_tm REFLECT      ; $E9
	add_tm ROCK_THROW   ; $EA	Replaced Bide, since I basically removed it from the game
	add_tm METRONOME    ; $EB
