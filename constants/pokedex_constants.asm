...
; - MonsterPalettes (see data/pokemon/palettes.asm)
	...
	const DEX_H_GROWLITHE; 
	const DEX_H_ARCANINE ; 
	...
	const DEX_MEW        ; 151
	const DEX_YANMA        ; 151
	const DEX_YANMEGA        ; 151
	const DEX_MURKROW        ; 151
	const DEX_HONCHKROW        ; 151
	const DEX_SNEASEL        ; 151
	const DEX_WEAVILE        ; 151
	const DEX_HOUNDOUR        ; 151
	const DEX_HOUNDOOM        ; 151
	const DEX_LARVITAR        ; 151
	const DEX_PUPITAR        ; 151
	const DEX_TYRANITAR        ; 151
