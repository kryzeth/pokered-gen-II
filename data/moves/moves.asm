...
; Characteristics of each move.
	...
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        50, FIGHTING,     100, 25	; Karate Chop is now Fighting
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,        85, 10
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, FIGHTING,      85, 15	; Comet Punch is now Fighting
	...
	move RAZOR_WIND,   CHARGE_EFFECT,               80, FLYING,        75, 10	; Razor Wind is now Flying
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        50, BUG,	       95, 30	; Cut is now Bug
	move GUST,         ANTI_FLY_EFFECT,		        40, FLYING,       100, 35	; Gust can hit opponent using Fly
	...
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, GROUND,       100, 15	; Sand Attack is now Ground
	...
	move BLIZZARD,     FREEZE_SIDE_EFFECT,         120, ICE,           75,  5	; Nerfed from 90 to 75 accuracy
	...
	move SUBMISSION,   RECOIL_EFFECT,              100, FIGHTING,      95, 25	; Buffed from 80/80 to 100/95
	...
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        40, ROCK,          95, 15	; Buffed from 40/95 from 50/65
	...
	move BIDE,         FOCUS_ENERGY_EFFECT,                  0, NORMAL,       100, 10
	move METRONOME,    METRONOME_EFFECT,             0, NORMAL,       100, 10
	move MIRROR_MOVE,  MIRROR_MOVE_EFFECT,           0, FLYING,       100, 20
	move SELFDESTRUCT, EXPLODE_EFFECT,             130, NORMAL,       100,  5
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       100, NORMAL,        85, 10	; Buffed from 75 to 85 acc
	move LICK,         PARALYZE_SIDE_EFFECT2,       20, GHOST,        100, 30
	move SMOG,         POISON_SIDE_EFFECT2,         35, POISON,       100, 20	; Buffed from 75 to 100 acc
	move SLUDGE,       POISON_SIDE_EFFECT2,         65, POISON,       100, 20
	move BONE_CLUB,    FLINCH_SIDE_EFFECT1,         65, GROUND,        95, 20	; Buffed from 85 to 95 accuracy
	...
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  15, GRASS,         85, 20	; Barrage is now Grass
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             40, BUG,          100, 15	; Buffed from 20 to 40 power.
	...
	move FLASH,        ACCURACY_DOWN1_EFFECT,       20, NORMAL,        90, 20	; Buffed from 0/70 to 20/90
	...
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         55, GROUND,       100, 10	; Buffed from 50/90, to 55/100
