...
ErikaData:
	db $FF, 24, TANGELA, 29, VICTREEBEL, 29, VILEPLUME, 0

KogaData:
	db $FF, 37, KOFFING, 39, MUK, 39, WEEZING, 43, VENOMOTH, 0

BlaineData:
	db $FF, 42, ARCANINE, 42, NINETALES, 44, RAPIDASH, 47, MAGMAR, 0

SabrinaData:
	db $FF, 37, KADABRA, 38, MR_MIME, 38, VENOMOTH, 43, ALAKAZAM, 0
