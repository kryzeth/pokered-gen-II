...
;	db MT_MOON_1F, MTMOON1F_TM_NUGGET,	  SHOW	; Replaced TM Water Gun with Nugget
MtMoonB2FHS:
...
PokemonMansionB1FHS:
	...
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_TM_FIRE_BLAST, SHOW	; Replaced Blizzard
...
SeafoamIslandsB4FHS:
	...
	db SEAFOAM_ISLANDS_B4F, SEAFOAMISLANDSB4F_TM_BLIZZARD, SHOW	; added TM Blizzard
	db $FF, $01, SHOW ; end
