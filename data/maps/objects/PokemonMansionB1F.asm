	...
	const_export POKEMONMANSIONB1F_TM_FIRE_BLAST	; replaced Blizzard
...
PokemonMansionB1F_Object:
	...
	object_event 19, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_FIRE_BLAST, TM_FIRE_BLAST	; Replaced Blizzard
