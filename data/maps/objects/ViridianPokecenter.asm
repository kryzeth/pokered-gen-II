...
ViridianPokecenter_Object:
	...
	object_event  6,  3, SPRITE_GAMBLER, STAY, NONE, TEXT_VIRIDIANPOKECENTER_MOVE_DELETER
	object_event  7,  3, SPRITE_SCIENTIST, STAY, NONE, TEXT_VIRIDIANPOKECENTER_MOVE_RELEARNER
